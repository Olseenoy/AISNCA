...
if "history" not in st.session_state:
    st.session_state.history = []  # list of dicts {role, text, timestamp, meta}
...
with form_col:
    ...
    if st.button("Submit / Analyze"):
        ...
        # Prepare retrieved evidence text
        evidence_text = ""
        ...
        # Create prompt to expand root cause and generate CAPA
        # We will take the top result's root cause if exists else use user text
        ...
        # Call LLM to expand root cause / generate CAPA
        try:
        ...
        # Present outputs and let user finalize
